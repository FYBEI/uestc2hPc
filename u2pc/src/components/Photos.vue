<template>
    <div id="slider">
        <div class="window" @mouseover="stop" @mouseleave="play">
            ...
            <ul class="direction">
                <li class="leftb" @click="move(400, 1, speed)">
                ...
                <li class="rightb" @click="move(400, -1, speed)">
            ...
            <ul class="dots">
                <li v-for="(dot, i) in pictures" :key="i" 
...
export default {
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/400 : this.currentIndex -= offset/400
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -2000) this.distance = -400
          if (des > -400) this.distance = -2000
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1
      const offset = Math.abs(index - this.currentIndex) * 400
